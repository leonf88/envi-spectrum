; $Id: //depot/idl/releases/IDL_80/idldir/lib/arrow_internal.pro#1 $
...
;   CT: May 2010: changed name to arrow_internal, moved calling routine
;      to the lib/graphics arrow.pro function (to avoid name conflicts).
;-

;  Draw an arrow with a head from (x0,y0) to (x1, y1).  Params may be
;		vectors.
PRO ARROW_INTERNAL, x0, y0, x1, y1, HSIZE = hsize, COLOR = color, HTHICK = hthick, $
